...
@Component
public class  SectorModelResumeAssembler{

    @Autowired
    private ModelMapper modelMapper;

    public SectorModelResume toResource(Sector sector){
        return modelMapper.map(sector, SectorModelResume.class);
    }

    public List<SectorModelResume> toCollectionResource(List<Sector> sectors){
