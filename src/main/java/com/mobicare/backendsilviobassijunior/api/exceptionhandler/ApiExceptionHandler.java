package com.mobicare.backendsilviobassijunior.api.exceptionhandler;
...
import com.mobicare.backendsilviobassijunior.domain.exception.EntityNotFoundException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleDuplicateEntity(DataIntegrityViolationException ex, WebRequest request){
		...
		Problem problem = createProblemBuilder(status, ProblemType.DUPLICATE_ENTITY, detail)
				.userMessage("O dado informado já existe! Informe um novo valor.")
				.build();
